...
import {
    ...
    setDocumentEditingState,
} from "../../../react/features/upload-presentation";
...
class UploadPresentation extends LargeContainer {
    /**
     * Creates new Upload Presentation object
     */
    constructor(url) {
        console.log("hello");
        super();
        ...
        iframe.src = "https://jitsidemo.cdac.in/fileupload/";
        //iframe.src = url;
...
/**
 * Manager of the Upload Presentation frame.
 */
export default class UploadPresentationManager {
    /**
     *
     */
    constructor(eventEmitter) {
        this.eventEmitter = eventEmitter;
        this.uploadpresentation = null;
    }
     ...
     */
    get isOpen() {
        return Boolean(this.uploadpresentation);
    }
    ...
    /**
     * Create new Upload Presentation frame.
     */
    openUploadPresentation() {
        this.uploadpresentation = new UploadPresentation(
            getSharedDocumentUrl(APP.store.getState)
        );
    ...
    /**
     * Toggle Upload Presentation frame visibility.
     * Open new Upload Presentation frame if there is no Etherpad frame yet.
     */
    toggleUploadPresentation() {
        console.log("entered");
        if (!this.isOpen) {
            this.openUploadPresentation();
        }
